                    ...
                    <form class="form-horizontal" novalidate method="post" id="editar_cliente" name="editar_cliente">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-label-group in-border">
                                    <input type="text" class="form-control validacionDui" id="mod_dui_cliente" name="mod_dui_cliente"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" id="tipo_cli">
                                <div class="form-label-group in-border">
                                    <select class="form-control" id="mod_tipo_cliente" name="mod_tipo_cliente" aria-describedby="tipCli" required >
                                        <option value="" selected>Seleccione</option>
