                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-label-group in-border">
                                    <input type="text" class="form-control" id="mod_dui_cliente" name="mod_dui_cliente" required />
                                    <label for="mod_dui_cliente">Dui cliente</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-label-group in-border">
                                    ...
                                    <label for="mod_nombre_cliente">Nombre cliente</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3" id="estado_cli">
                                <div class="form-label-group in-border input-grup">
                                <select class="form-select validate" id="mod_estado_cliente" name="mod_estado_cliente" aria-describedby="estCli" required >
                            ...
                            <div class="col-md-3" id="tipo_cli">
                                <div class="form-label-group in-border">
                                    <select class="form-select validate" id="mod_tipo_cliente" name="mod_tipo_cliente" aria-describedby="tipCli" required >
                                        <option value="" selected>Seleccione</option>
