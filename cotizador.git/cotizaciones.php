...
<head>
	...
	<link rel="icon" href="assets/images/cart_icon2.png">
	 <!--alerts CSS -->
    <link href="assets/plugins/sweetalert/sweetalert.css" rel="stylesheet" type="text/css"><link href="assets/plugins/daterangepicker/daterangepicker.css" rel="stylesheet">
</head>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Buscar cotizaciones</h4>
								  ...
								  <div class="col-md-3">
									<input type="text" name="daterange" id="daterange" value="01/02/2023 - 02/02/2023" class="form-control daterange" readonly  />
								  </div>
