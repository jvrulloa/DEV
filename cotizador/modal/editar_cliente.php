...
?>
<div class="modal fade" id="editCliente"  role="dialog" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="editar_cliente" name="editar_cliente">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-label-group">
                                <select class="form-control outline" id="mod_estado_cliente" name="mod_estado_cliente">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                             <div class="form-floating">
                                <select class="form-select select2" id="mod_giro" name="mod_giro" aria-label="Default select example">
                                ...
                                <label class="form-label select-label activate" for="mod_giro"></label>
                             </div>
                        </div> 
                        <div class="col-md-3">
                            <div class="form-outline">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <div class="form-floating">
                                <select class="form-select select2" id="mod_depto" name="mod_depto" aria-label="Default select example" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <select class="form-select" id="mod_muni" name="mod_muni" aria-label="Default select example" required>
                                <option value="">Seleccione</option>
                                </select>
